...
.barapp .tsel{display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap;background:#1B2648;border:1.5px solid #F0B429;border-radius:12px;padding:10px 14px;font-size:14px}
.barapp .tsel b{font-size:16px}
.barapp .tsel .ok{color:#F0B429;font-weight:700}
.barapp .tsel .none{color:rgba(255,255,255,.55)}
